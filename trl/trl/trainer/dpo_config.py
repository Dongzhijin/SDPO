...
class DPOConfig(TrainingArguments):
    ...
    Parameters:
        ...
        loss_type (`str`, *optional*, defaults to `"sigmoid"`):
            Type of loss to use. Possible values are:
                ...
                - `"sdpo"`: SDPO (Selective Direct Preference Optimization) loss that masks unimportant tokens
                  based on importance scores derived from policy-reference model log probability differences.
    ...
    sdpo_threshold: float = field(
        default=0.6,
        metadata={
            "help": "Quantile threshold for SDPO token importance masking. Tokens with importance scores above this "
            "quantile will be retained in the loss computation. Higher values mean more selective masking, keeping "
            "only the most important tokens. Range: [0.0, 1.0]. Default: 0.6."
        },
    )
